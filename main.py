            ...
            if condition == 'sell'  and not openposition and condition != 'notrade':
                ...
                #tracking the stop loss and target
                    ...
                    if ltp >= positionConfig['SL']:
                        ...
                        orderid = dhanObj.closePositionBySymQtyTransType(positionConfig['security_id'], positionConfig['qty'],transType='SELL')#not giving trans type as it will determine        
    ...
    while utility.getTimeCondition():
        try:
            if condition == 'neutral' and not openposition and condition != 'notrade':
                    ...
                    dhanObj.subscribe_symbols([(MarketFeed.NSE_FNO,str(security_id_ce), MarketFeed.Ticker)])
                    ...
                    dhanObj.subscribe_symbols([(MarketFeed.NSE_FNO,str(security_id_pe), MarketFeed.Ticker)])
